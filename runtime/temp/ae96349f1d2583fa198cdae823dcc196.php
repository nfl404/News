<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/Users/huadiwenhua/Desktop/News/public/../application/admin/view/link/store.html";i:1501840706;s:74:"/Users/huadiwenhua/Desktop/News/public/../application/admin/view/base.html";i:1502705628;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name=""  class="form-control" placeholder="请填写友链名称">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="url" name="ctitle"  class="form-control" placeholder="">
                </div>
            </div>
            <div class="form-group">
