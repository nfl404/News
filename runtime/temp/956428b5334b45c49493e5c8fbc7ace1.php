...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="">视频添加</a></li>
</ul>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="video_author"  class="form-control" placeholder="上传作者" value="艺术资讯网">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">视频排序</label>
                <div class="col-sm-9">
                    <input type="number" name="video_sort"  class="form-control" placeholder="视频排序" value="100">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <input type="text" class="form-control" name="video_thumb" readonly="" value="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <input type="text" class="form-control" name="video_url" readonly="" value="">
                        <div class="input-group-btn">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea type="text" name="video_digest"  class="form-control" placeholder="视频摘要"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for=""  class="col-sm-2 control-label">视频内容</label>
                <div class="col-sm-9">
                    <textarea id="container"name="video_content" style="height:300px;width:100%;"></textarea>
                    <script>
