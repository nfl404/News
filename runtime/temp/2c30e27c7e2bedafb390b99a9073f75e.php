<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/Users/huadiwenhua/Desktop/news_c/public/../application/admin/view/login/index.html";i:1501483967;}*/ ?>
<!DOCTYPE html>
<html lang="en" class="bg-dark">
<head>
    <meta charset="utf-8"/>
    <title>艺术资讯网后台登陆</title>
...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xxl">
        <a class="navbar-brand block" href="">艺术资讯网后台管理</a>
...
<footer id="footer">
    <div class="text-center padder">
        <p>
            <small>Powered By blog.niefuling.com<br> copyright &copy; 2017</small>
        </p>
    </div>
</footer>
