<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Users/huadiwenhua/Desktop/News/public/../application/admin/view/audio/index.html";i:1502694903;s:74:"/Users/huadiwenhua/Desktop/News/public/../application/admin/view/base.html";i:1502705628;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li><a href="<?php echo url('store'); ?>">音频添加</a></li>
</ul>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?php echo url('edit',['audio_id'=>$vo['audio_id']]); ?>">编辑</a></li>
                                <li class="divider"></li>
                                <li><a href="javascript:" onclick="del(<?php echo $vo['audio_id']; ?>)">删除到回收站</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
...
<script>
    function del(audio_id) {
        util.confirm('确定删除到回收站吗？',function(){
            location.href="<?php echo url('del'); ?>"+'?audio_id='+audio_id;
        })
    }
</script>
