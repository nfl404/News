<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Users/huadiwenhua/Desktop/News/public/../application/admin/view/audio/store.html";i:1502679230;s:74:"/Users/huadiwenhua/Desktop/News/public/../application/admin/view/base.html";i:1502681609;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="">音频添加</a></li>
</ul>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="audio_title"  class="form-control" placeholder="音频标题">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">上传作者</label>
                <div class="col-sm-9">
                    <input type="text" name="audio_author"  class="form-control" placeholder="上传作者" value="艺术资讯网">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">音频排序</label>
                <div class="col-sm-9">
                    <input type="number" name="audio_sort"  class="form-control" placeholder="音频排序" value="100">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="js-example-basic-single form-control" name="cate_id">
                        ...
                        <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): if( count($cateData)==0 ) : echo "" ;else: foreach($cateData as $key=>$v): ?>
                        <option value="<?php echo $v['cate_id']; ?>"><?php echo $v['_cate_name']; ?></option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <input type="text" class="form-control" name="audio_thumb" readonly="" value="">
            ...
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">音频文件</label>
                <div class="col-sm-9">
                    <div class="input-group">
                        <input type="text" class="form-control" name="audio_url" readonly="" value="">
                        <div class="input-group-btn">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea type="text" name="audio_digest"  class="form-control" placeholder="音频摘要"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for=""  class="col-sm-2 control-label">音频内容</label>
                <div class="col-sm-9">
                    <textarea id="container"name="audio_content" style="height:300px;width:100%;"></textarea>
                    <script>
